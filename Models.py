...
# for providing easy-to-understand Transformer model written in PyTorch
...
# Either using new Pytorch memory-efficient dot_product or the traditional torch.matmul
